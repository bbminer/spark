...
object SessionFat {
  ...
  case class UserVisitAction(actionDate: String, userId: String, sessionId: String,
                             pageId: String, actionTime: Date, keyWord: String,
                             clickProductId: String, clickCateageId: String,
                             orderCategoryId: String, orderProductId: String,
                             payProductId: String, payCategoryId: String)
  ...
  def main(args: Array[String]): Unit = {
    ...
    val sessionStaticRdd = userVisitActionRdd.map(f => {
    ...
    //统计session
    val actionStaticRdd = sessionStaticRdd.map(f => {f
      //时间     访问时长   步长
    ...
    actionStaticRdd.take(1).map(f => {
      (f._1, (f._2._1 * 1.0 / f._2._16,
        f._2._2 * 1.0 / f._2._16, f._2._3 * 1.0 / f._2._16,
        f._2._4 * 1.0 / f._2._16, f._2._5 * 1.0 / f._2._16,
        f._2._6 * 1.0 / f._2._16, f._2._7 * 1.0 / f._2._16,
        f._2._8 * 1.0 / f._2._16, f._2._9 * 1.0 / f._2._16,
        f._2._10 * 1.0 / f._2._16, f._2._11 * 1.0 / f._2._16,
        f._2._12 * 1.0 / f._2._16, f._2._13 * 1.0 / f._2._16,
        f._2._14 * 1.0 / f._2._16, f._2._15 * 1.0 / f._2._16
      ))
    }).foreach(println)
  }
}
